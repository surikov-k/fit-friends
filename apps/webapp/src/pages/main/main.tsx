                ...
                <div className="thumbnail-preview">
                  <div className="thumbnail-preview__image">
                    <picture>
                      <source
                        type="image/webp"
                        srcSet="../../assets/img/content/thumbnails/preview-03.webp, ../../assets/img/content/thumbnails/preview-03@2x.webp 2x"
                      />
                      <img
                        src="../../assets/img/content/thumbnails/preview-03.jpg"
                        srcSet="../../assets/img/content/thumbnails/preview-03@2x.jpg 2x"
                        width="452"
                        height="191"
                        alt=""
                      />
                ...
                <div className="thumbnail-preview">
                  <div className="thumbnail-preview__image">
                    <picture>
                      <source
                        type="image/webp"
                        srcSet="../../assets/img/content/thumbnails/preview-02.webp, ../../assets/img/content/thumbnails/preview-02@2x.webp 2x"
                      />
                      <img
                        src="../../assets/img/content/thumbnails/preview-02.jpg"
                        srcSet="../../assets/img/content/thumbnails/preview-02@2x.jpg 2x"
                        width="452"
                        height="191"
                        alt=""
                      />
                ...
                <div className="thumbnail-preview">
                  <div className="thumbnail-preview__image">
                    <picture>
                      <source
                        type="image/webp"
                        srcSet="../../assets/img/content/thumbnails/preview-01.webp, ../../assets/img/content/thumbnails/preview-01@2x.webp 2x"
                      />
                      <img
                        src="../../assets/img/content/thumbnails/preview-01.jpg"
                        srcSet="../../assets/img/content/thumbnails/preview-01@2x.jpg 2x"
                        width="452"
                        height="191"
                        alt=""
                      />
            ...
            <ul className="special-offers__list">
              <li className="special-offers__item is-active">
                <aside className="promo-slider">
                  ...
                  <div className="promo-slider__image">
                    <img
                      src="../../assets/img/content/promo-1.png"
                      srcSet="../../assets/img/content/promo-1@2x.png 2x"
                      width="1040"
                      height="469"
                      alt="promo-photo"
                    />
              ...
              <li className="special-offers__item">
                <aside className="promo-slider">
                  ...
                  <div className="promo-slider__image">
                    <img
                      src="../../assets/img/content/promo-2.png"
                      srcSet="../../assets/img/content/promo-2@2x.png 2x"
                      width="1040"
                      height="469"
                      alt="promo-photo"
                    />
              ...
              <li className="special-offers__item">
                <aside className="promo-slider">
                  ...
                  <div className="promo-slider__image">
                    <img
                      src="../../assets/img/content/promo-3.png"
                      srcSet="../../assets/img/content/promo-3@2x.png 2x"
                      width="1040"
                      height="469"
                      alt="promo-photo"
                    />
                  ...
                  <div className="thumbnail-training__inner">
                    <div className="thumbnail-training__image">
                      <picture>
                        <source
                          type="image/webp"
                          srcSet="../../assets/img/content/thumbnails/training-06.webp, ../../assets/img/content/thumbnails/training-06@2x.webp 2x"
                        />
                        <img
                          src="../../assets/img/content/thumbnails/training-06.jpg"
                          srcSet="../../assets/img/content/thumbnails/training-06@2x.jpg 2x"
                          width="330"
                          height="190"
                          alt=""
                        />
                  ...
                  <div className="thumbnail-training__inner">
                    <div className="thumbnail-training__image">
                      <picture>
                        <source
                          type="image/webp"
                          srcSet="../../assets/img/content/thumbnails/training-07.webp, ../../assets/img/content/thumbnails/training-07@2x.webp 2x"
                        />
                        <img
                          src="../../assets/img/content/thumbnails/training-07.jpg"
                          srcSet="../../assets/img/content/thumbnails/training-07@2x.jpg 2x"
                          width="330"
                          height="190"
                          alt=""
                        />
                  ...
                  <div className="thumbnail-training__inner">
                    <div className="thumbnail-training__image">
                      <picture>
                        <source
                          type="image/webp"
                          srcSet="../../assets/img/content/thumbnails/training-11.webp, ../../assets/img/content/thumbnails/training-11@2x.webp 2x"
                        />
                        <img
                          src="../../assets/img/content/thumbnails/training-11.jpg"
                          srcSet="../../assets/img/content/thumbnails/training-11@2x.jpg 2x"
                          width="330"
                          height="190"
                          alt=""
                        />
                  ...
                  <div className="thumbnail-training__inner">
                    <div className="thumbnail-training__image">
                      <picture>
                        <source
                          type="image/webp"
                          srcSet="../../assets/img/content/thumbnails/training-09.webp, ../../assets/img/content/thumbnails/training-09@2x.webp 2x"
                        />
                        <img
                          src="../../assets/img/content/thumbnails/training-09.jpg"
                          srcSet="../../assets/img/content/thumbnails/training-09@2x.jpg 2x"
                          width="330"
                          height="190"
                          alt=""
                        />
                ...
                <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
                  <div className="thumbnail-user__image">
                    <picture>
                      <source
                        type="image/webp"
                        srcSet="../../assets/img/content/thumbnails/user-04.webp, ../../assets/img/content/thumbnails/user-04@2x.webp 2x"
                      />
                      <img
                        src="../../assets/img/content/thumbnails/user-04.jpg"
                        srcSet="../../assets/img/content/thumbnails/user-04@2x.jpg 2x"
                        width="82"
                        height="82"
                        alt=""
                      />
                ...
                <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
                  <div className="thumbnail-user__image">
                    <picture>
                      <source
                        type="image/webp"
                        srcSet="../../assets/img/content/thumbnails/user-05.webp, ../../assets/img/content/thumbnails/user-05@2x.webp 2x"
                      />
                      <img
                        src="../../assets/img/content/thumbnails/user-05.jpg"
                        srcSet="../../assets/img/content/thumbnails/user-05@2x.jpg 2x"
                        width="82"
                        height="82"
                        alt=""
                      />
                ...
                <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
                  <div className="thumbnail-user__image">
                    <picture>
                      <source
                        type="image/webp"
                        srcSet="../../assets/img/content/thumbnails/user-06.webp, ../../assets/img/content/thumbnails/user-06@2x.webp 2x"
                      />
                      <img
                        src="../../assets/img/content/thumbnails/user-06.jpg"
                        srcSet="../../assets/img/content/thumbnails/user-06@2x.jpg 2x"
                        width="82"
                        height="82"
                        alt=""
                      />
                ...
                <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
                  <div className="thumbnail-user__image">
                    <picture>
                      <source
                        type="image/webp"
                        srcSet="../../assets/img/content/thumbnails/user-07.webp, ../../assets/img/content/thumbnails/user-07@2x.webp 2x"
                      />
                      <img
                        src="../../assets/img/content/thumbnails/user-07.jpg"
                        srcSet="../../assets/img/content/thumbnails/user-07@2x.jpg 2x"
                        width="82"
                        height="82"
                        alt=""
                      />
