...
import { UserInterface, UserRole, Location } from "@fit-friends/shared-types";
...
const seedData: UserInterface[] = [
  {
    ...
    passwordHash: '$2b$10$GvGg7VNY.NQ1D.T4w.6XDOIoFydEekHHxs8JtL/K4f6gWFRsoNYxK',
    avatar: 'avatar.jpg',
    gender: 'Male',
  ...
  },
  {
    ...
    passwordHash: '$2b$10$9UUVorInlmsVunb2BpN0v.h3.wuhjKpX7eO4XJoNtZqnEcHXLu5Gq',
    avatar: 'avatar.jpg',
    gender: 'Female',
...
async function bootstrap() {
  ...
  const users = await Promise.all(seedData.map(async (data) => {
